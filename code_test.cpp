...
// Include the file where the Djkstra and printPath functions are defined.
// Assuming the file is named dijkstra.h for this example.
#include "code.cpp"

// Helper function to set up a graph for testing
void SetUpGraph(int graph[MAX_N][MAX_N],
...
TEST_F(DijkstraTest, FindsShortestPathInSimpleGraph) {
  ...
  // 3 4 5
  // 6 7 8
  std::vector<std::vector<int>> input = {{0, 1, 100}, {1, 100, 1}, {100, 1, 0}};
  ...
  Djkstra(3, 3); // Run Dijkstra on the graph
